...
if __name__ == "__main__":
  ...
  # data_folder = "/media/minh/Data/avl_lane_failure_cases/ground_test_set"
  # lane_folder = "/media/minh/Data/avl_lane_failure_cases/ground_test_set_poly_fit"
  visulize_lane_line = True  # Visualize lane line if available
